...
class SnakeGame extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isGameOver: false,
      snakeColor: this.props.snakeColor || '#4ade80',
      appleColor: this.props.appleColor || '#ef4444',
      score: 0,
      ...
      <div className="snake-game">
        <div className="score-panel">
          ...
          <div className="score-item">
            ...
            <span className="score-value score-value--high">
